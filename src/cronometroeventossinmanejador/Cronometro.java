...
public class Cronometro extends JLabel implements Serializable, CronometroEventListener {
        ...
        task = new TimerTask()
            ...
            public void run()
            {
                ...
                if (tiempo==(int)d1.toSeconds()){
                    StopCronometro(new CronometroEventObject(this));
    ...
    public void StopCronometro(CronometroEventObject args) {
       ...
       System.out.println("Voy a parar el cronometro sobreescribiendo los métodos de la interface");
       //task.cancel();
        setActivo(false);
    ...
    public void StartCronometro(CronometroEventObject args) {
        // TODO Auto-generated method stub
        System.out.println("Voy a inicializar el cronometro sobreescribiendo los métodos de la interface");
        //contar();
        setActivo(true);
